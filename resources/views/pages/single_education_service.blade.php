                    ...
                    <div class="post-details-content mb-100">
                        <div class="card">
                            <div class="card-header" style="text-align:center;color:#ff7b00; font-weight:700; font-family:'Times New Roman', Times, serif;">
                                {{ $education_service->title }} 
                            </div>
                            <div class="card-body">
                                <p style="text-align:justify; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color:black">{{ $education_service->description }}</p>
                            </div>
                        </div>
